...
albo postać nie zostanie dodana. Zmienisz to w ustawieniach świata. 

true oznacza, że gracz posiada do czegoś dostęp. false oznacza, że takiego dostępu nie ma.

Ardoonga Engine nie narzuca jak mają się nazywać zmienne, a sekcje tylko 
ograniczają ilość wyświetlanych informacji.
...
Creative Commons ma mniej ciekawostek prawniczych. Największa kontrowersja dotyczy CC-BY 4.0 które dogadało się z GPL 3.0 ale zapomniało o wszystkich innych wersjach, więc legalnie nie możesz trzymać zdjęć w folderach z grą.

Na szczęście definicja definicji definiuje program jako wszystko, czego potrzebuję do uruchomienia. Jeśli mój program przetwarza pliki, które pobierze sobie osobno z innej strony to w żaden sposób nie naruszam licencji.
...
Zresztą raz widziałem grę, gdzie mnich był w stanie pokonać każdego bosa. Spotykałeś tam 
nauczycielkę, która po przegranej walce uczyła Cię paraliżu na 2 tury. Więc robiłeś 
...
Jeśli chcesz przenieść DnD musisz znać sztukę programowania w pseudo-Lisp na zaawansowanym poziomie. 
