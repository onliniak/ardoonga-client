...
//https://www.dndbeyond.com/sources/dnd/basic-rules-2014 ← Z tego na 100% mogę korzystać
//https://www.dndbeyond.com/sources/dnd/free-rules ← Nie mam pewności, czy mogę.
